...
[Robotik](https://sonsuzus.github.io/search.html?q=robotik) kodlama robotomuzun istenilen amaca yönelik işlemleri yapma sürecidir diyebiliriz kısaca. Bu aşamada [robot](https://sonsuzus.github.io/search.html?q=robot) somut bir nesne olmak zorunda değildir. Bir yazılım ve görsel veya sanal bir yapıda da olabilir. Bu tasarım ve [programlama](https://sonsuzus.github.io/search.html?q=programlama) süreci bittiğinde elektronik devreleri olan robotumuza yazılım yüklemesi yapıp onun somut şekilde istenilen biçimde hareket etmesini veya istediğimiz işleri yapmasını sağlayabiliriz.
