...
[Map](https://sonsuzus.github.io/search.html?q=map) sınıfı, benzersiz anahtarların belirli değerlerle eşleşdiği bir ilişkisel konteynerdir. Map, içinde [anahtar/değer](https://sonsuzus.github.io/search.html?q=anahtar/de%C4%9Fer) ikililerinden oluşan bir liste yer alır. Anahtar bir ismi ifade eder ve bu isim karşılığında bir değer yer alır. Anahtar adını kullanarak kaydettiğimiz bir değeri, yine anahtar adını kullanarak okuyabiliriz.
...
Map konteynerleri aşağıdaki [constructor](https://sonsuzus.github.io/search.html?q=constructor) fonksiyonlarını içerir:
