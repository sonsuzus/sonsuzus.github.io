...
[İfade](https://sonsuzus.github.io/search.html?q=ifade) (expression) adı verilen yapı içinde, program değişken ve sabitlerden oluşan verilere işlemciler yoluyla bir işlem yapar. Artık, ifadeleri oluşturan veri kavramını incelemeye başlayabiliriz.
...
| Anahtar kelime | [Veri türü](https://sonsuzus.github.io/search.html?q=veri%20t%C3%BCr%C3%BC) |
| bool | İkili |
| char | Karakter |
| int | Tamsayı |
...
| [Değiştirici](https://sonsuzus.github.io/search.html?q=de%C4%9Fi%C5%9Ftirici) | Uygulandığı veri türü |
| signed | char, int |
| unsigned | char, int |
| long | int, double |
| short | int |
