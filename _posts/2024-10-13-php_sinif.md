...
PHP'de [sınıf](https://sonsuzus.github.io/search.html?q=s%C4%B1n%C4%B1f) içinde aynı veya farklı veri türünden sabit ve değişkenlerle, bu sabit ve değişkenleri kullanan ve işlem yapan fonksiyonlardan oluşan bir yapıdır. Sınıf içinde yer alan değişkenler özellik (property), fonksiyonlar ise [metod](https://sonsuzus.github.io/search.html?q=metod) (method) olarakta adlandırılır. Temel sınıf bildirimi class anahtar kelimesi ve peşinden gelen sınıf adı ile başlar. Daha sonra, sınıf sabit ve değişkenleri ile fonksiyon tanımlamalarının arasında yer aldığı { } parentezleri kullanılır. Geçerli bir sınıf adı bir harf veya alt çizgi ile başlar ve herhangi bir sayıda harf, sayı veya alt çizgilerle devam eder.
...
Sınıf içindeki bir fonksiyondan bir veri değişkenine erişim için $[this](https://sonsuzus.github.io/search.html?q=this)-> ifadesi kullanılmaktadır.
