...
List sınıfı, [çift yönlü](https://sonsuzus.github.io/search.html?q=%C3%A7ift%20y%C3%B6nl%C3%BC) ve doğrusal bir liste sağlar. Bir listedeki elemanlara sadece sıralı olarak erişim sağlanabilir. Elemanlara rastgele erişim yapılamaz. Çift yönlü olduğu için baştan sona veya sondan başa doğru erişim sağlanabilir.
...
| iterator begin();const\_iterator begin() const; | Listedeki ilk elemanı gösteren bir [tekrarlayıcı](https://sonsuzus.github.io/search.html?q=tekrarlay%C4%B1c%C4%B1) geri döndürür. |
...
| reference front();const\_reference front() const; | Listedeki ilk elemanı gösteren bir [referans](https://sonsuzus.github.io/search.html?q=referans) geri döndürür. |
