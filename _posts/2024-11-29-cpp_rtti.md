...
Bir nesnenin veri türünü elde etmek için, aşağıda iki farklı genel yapısı verilen ve `<typeinfo>` başlık dosyasında yer alan [typeid](https://sonsuzus.github.io/search.html?q=typeid) işlemcisini kullanabiliriz.
