...
[C](https://sonsuzus.github.io/tags.html#c) [Programlama](https://sonsuzus.github.io/tags.html#programlama) oldukça eski fakat hala güncelliğini ve gücünü koruyan bir programlama dilidir. Bilgisayarın donanımını kontrol edebildiği için işletim sistemleri dahil bir çok uygulama ve oyun bu programlama dili ile geliştirilir. [C](https://sonsuzus.github.io/tags.html#c) programlama derken elbette C++ programlamıyı da içine almaktadır. En azından bu sayfada. 
...
int [main](https://sonsuzus.github.io/tags.html#main)()
{
  printf("Merhaba");
  return 0;
}
...
C programlama dilinde bir değişkeni kullanmadan önce tanımlamamız gerekir. Buna göre bellekten yer ayırmaktadır. Basit programlarla [algoritma](hhttps://sonsuzus.github.io/program/2019/04/28/algoritma.html) örneklerimizi yapmaya başlayalım.
