...
* Fonksiyonlara çoklu görev tanımlama ([Overloading](https://sonsuzus.github.io/search.html?q=overloading)) işlemi
* İşlemcilere çoklu görev tanımlama (Overloading) işlemi
* Sınıf fonksiyonlarını doğrudan yeniden tanımlama (Overriding)
* Sınıf fonksiyonlarını sanal yöntemle ([virtual](https://sonsuzus.github.io/search.html?q=virtual)) yeniden tanımlama (Overriding)
