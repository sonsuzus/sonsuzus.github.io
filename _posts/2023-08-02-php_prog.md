...
PHP dosyalarını oluşturmak için Notepad veya benzeri herhangi bir metin düzenleyici program kullanabilirsiniz. Size, Türkçe dil desteğine sahip ve ücretsiz bir yazılım olan [Notepad++](https://notepad-plus-plus.org/) Metin Düzenleyicisini kullanmanızı öneriyoruz.
