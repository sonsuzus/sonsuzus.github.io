...
Bu bölümde, C temelli [dosya](https://sonsuzus.github.io/search.html?q=dosya) giriş ve çıkış işlemlerini incelemeye çalışacağız. Bu işlemler üzerinde çalışmaya başlamadan önce, [akış](https://sonsuzus.github.io/search.html?q=ak%C4%B1%C5%9F) ve dosya kavramlarını ayrı ayrı ele alalım:
...
Akış, [stdio.h](https://sonsuzus.github.io/search.html?q=stdio.h) başlık dosyası içinde tanımlı FILE adlı yapı veri türünden bildirimi yapılan bir işaretçi değişkeni ile kullanılan bir dosya veya fiziksel bir cihazdır.
